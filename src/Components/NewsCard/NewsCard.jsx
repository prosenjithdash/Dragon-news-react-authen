...
const NewsCard = ({ news }) => {
    ...
    return (
        <div>
            ...
            <div className="flex flex-col max-w-lg mb-10 p-6 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-50 dark:text-gray-800">
                ...
                <div>
                    ...
                    {
                        details.length > 200 ? <p className="text-sm dark:text-gray-600">{details.slice(0, 200)}
                            <Link to={`/news/${_id}`} className="text-[18px] font-bold text-blue-600"> Read More...</Link>
                        </p> : <p className="text-sm dark:text-gray-600">{details}</p>
